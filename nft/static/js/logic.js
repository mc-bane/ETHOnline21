...
Moralis.initialize("55DnecKAjYUQAh7UtbbB9f3CoQm0f2BxGQTvRjNo"); // Application id from moralis.io
Moralis.serverURL = "https://cfrr70rls1zn.moralishost.com:2053/server"; //Server url from moralis.io
...
const Price_ETHAbi = [
    ...
    },
    {
      ...
      "name": "tokenIdTooddOrEven",
      "outputs": [
        {
          "internalType": "enum NumberCollectible.oddOrEven",
          "name": "",
          "type": "uint8"
        }
      ],
  ...
  ]//[{"inputs": [], "stateMutability": "nonpayable", "type": "constructor", "name": "constructor"}, {"inputs": [], "name": "getThePrice", "outputs": [{"internalType": "int256", "name": "", "type": "int256"}], "stateMutability": "view", "type": "function"}];
const number_n = new window.web3.eth.Contract(NumberCollectible,'0x2dEb6D15D1f3ed5AE224fbb6110721c08719AD94');

//dApp frontend logic
async function game_balance(){
    number_n.methods.getElementById()
